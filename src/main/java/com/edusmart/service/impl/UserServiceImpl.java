...
public class UserServiceImpl implements UserService {
    ...
    public Optional<User> getUserByGoogleId(String googleId) {
        ...
        return userDao.findByGoogleId(googleId.trim());
    }

    @Override
    public Optional<User> getUserByFaceDescriptor(String faceDescriptor) {
        if (faceDescriptor == null || faceDescriptor.isBlank()) {
            return Optional.empty();
        }
        return userDao.findByFaceDescriptor(faceDescriptor.trim());
    }
