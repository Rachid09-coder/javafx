...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        // Ensure DB tables required for the Shop exist (non-fatal)
        try {
            com.edusmart.util.DbMigrator.ensureShopTablesExist();
        } catch (Throwable t) {
            System.err.println("DB migrator reported: " + t.getMessage());
        }
