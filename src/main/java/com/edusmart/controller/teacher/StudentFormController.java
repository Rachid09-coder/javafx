...
public class StudentFormController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        roleComboBox.setItems(FXCollections.observableArrayList("etudiant", "professeur", "admin"));
    ...
    public void setEditMode(User user) {
        ...
        if (user.getRoleValue() != null) roleComboBox.setValue(User.normalizeDatabaseRole(user.getRoleValue()));
    ...
    private User buildUser() {
        ...
        if (userToEdit != null) {
            u.setResetToken(userToEdit.getResetToken());
            u.setResetTokenExpiresAt(userToEdit.getResetTokenExpiresAt());
            u.setGoogleId(userToEdit.getGoogleId());
            u.setFaceDescriptor(userToEdit.getFaceDescriptor());
            u.setEmailAssoc(userToEdit.getEmailAssoc());
            u.setSignaturePath(userToEdit.getSignaturePath());
        }
        return u;
    }
