...
public class UploadExamController {
    ...
    private void handleSubmit(ActionEvent event) {
        ...
        try {
            if (exam == null) {
                showAlert(Alert.AlertType.WARNING, "Attention", "Aucun examen n'est selectionne.");
                return;
            }
            ...
            sub.setStudentId(SessionManager.getCurrentUser() != null ? SessionManager.getCurrentUser().getId() : 2);
            sub.setStudentAnswer("Copie PDF soumise: " + destFile.getAbsolutePath());
