...
public class ProfileController implements Initializable {
    ...
    @FXML private TextField googleEmailField;
    @FXML private TextField faceDescriptorField;
    ...
    private void loadUserData() {
        ...
        googleEmailField.setText(fromGoogleId(currentUser.getGoogleId()));
        faceDescriptorField.setText(currentUser.getFaceDescriptor() != null ? currentUser.getFaceDescriptor() : "");
    ...
    private void handleSave(ActionEvent event) {
        ...
        String googleEmail = googleEmailField.getText().trim();
        currentUser.setGoogleId(googleEmail.isEmpty() ? null : toGoogleId(googleEmail));
        String faceDescriptor = faceDescriptorField.getText().trim();
        currentUser.setFaceDescriptor(faceDescriptor.isEmpty() ? null : faceDescriptor.toLowerCase());
    ...
    private String fromGoogleId(String googleId) {
        if (googleId == null || googleId.isBlank()) {
            return "";
        }
        return googleId.startsWith("google:") ? googleId.substring("google:".length()) : googleId;
    }
}
